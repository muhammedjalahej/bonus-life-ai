  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        setError(err.message || (isTr ? 'Kalp değerlendirmesi bulunamadı.' : 'Heart assessment not found or link expired.'));
      } finally {
        setLoading(false);
      }
    })();
  ...
  if (error) {
    return (
      <div className="max-w-lg mx-auto px-6 py-32 text-center">
        ...
        <h1 className="text-xl font-bold text-white mb-2">{isTr ? 'Kalp Değerlendirmesi Bulunamadı' : 'Heart Assessment Not Found'}</h1>
      ...
      <div className="p-6 rounded-2xl bg-white/[0.03] border border-white/[0.08]">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-white">{isTr ? 'Paylaşılan Kalp Değerlendirmesi' : 'Shared Heart Assessment'}</h1>
